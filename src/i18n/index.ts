...
export const SUPPORT_LOCALES = ['ru', 'us', 'cn', 'es', 'it', 'de', 'tr']
...
export function setupI18n(options: I18nOptions = { locale: 'cn' }): I18n {
...
export async function loadLocaleMessages(i18n: I18n, locale: Locale) {
  ...
  const messages = await import(/* @vite-ignore */ `./locales/${locale}.yaml`).then(getResourceMessages)
